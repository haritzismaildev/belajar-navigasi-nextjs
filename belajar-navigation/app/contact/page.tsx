        ...
        <div className="min-h-screen bg-gradient-to-br from-yellow-500 to yellow-700 flex items-center justify-center p-4">
            <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-2xl w-full">
                ...
                <div className="space-y-6 mb-8">
                    <div className="bg-purple-50 p-6 rounded-lg">
                        <h2 className="text-2xl font-bold text-yellow-600 mb-3">
                            Next.js 16 Navigation Demo
                        </h2>
                        <p className="text-gray-700 leading-relaxed">
                            Aplikasi ini dibuat untuk belajar <strong>Programmatic Navigation</strong>
                            di Next.js 16 menggunakan <code className="bg-purple-100 px-2 py-1 rounded">useRouter</code> hook.
                        </p>
                    </div>
                ...
                <div className="bg-purple-100 border-2 border-purple-400 text-purple-800 p-4 rounded-lg mb-6">
                    ...
                    <p className="text-sm">
                        Kamu berhasil pindah ke Contact menggunakan <code className="bg-purple-200 px-2 py-1 rounded">router.push()</code>
                    </p>
                </div>
                {/* Back Button */}
                <Link 
